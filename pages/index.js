...
import atm_abi from "../artifacts/contracts/ayushAssessment.sol/ayushAssessment.json";
...
export default function HomePage() {
  ...
  const [ownerName, setOwnerName] = useState("Ayush");
  const [ownerCity, setOwnerCity] = useState("Ludhiana");
  ...
  return (
    <main className="container">
      <header>
        <h1>WELCOME TO  ** Ayush Tech$hak **</h1>
        <p>Let's TRANSACT</p>
      ...
      <style jsx>
        {`
          .container {
            ...
            border-radius: 20px;
            background-image: url("https://i.pinimg.com/originals/62/91/a5/6291a57003d2e2509eb7cd599923d287.jpg");
            height: 850px;
            width: 1500px;
            opacity: 0.9 ;
            font-weight: 1000;
